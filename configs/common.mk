...
# init.d
PRODUCT_COPY_FILES += \
    vendor/iokp/prebuilt/common/etc/init.local.rc:root/init.iokp.rc \
...
PRODUCT_COPY_FILES += \
    vendor/iokp/prebuilt/bootanimation/bootanimation-kiernan.zip:system/media/bootanimation-alt.zip
